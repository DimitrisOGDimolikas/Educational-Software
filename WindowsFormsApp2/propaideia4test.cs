...
{
    public partial class propaideia4test : Form
    {
        public propaideia4test()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ερώτηση 1
            if (this.checkedListBox1.SelectedIndex.Equals(2))
            {
            ...
            // Σύνδεση με βάση
            String sql = "";
            sql = "UPDATE [Students] SET Score4 = @correct WHERE [FirstName] = @fname and [SecondName] = @lname";
