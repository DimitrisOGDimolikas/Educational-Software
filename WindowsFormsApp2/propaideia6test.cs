...
{
    public partial class propaideia6test : Form
    {
        public propaideia6test()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ερώτηση 2
            if (this.checkedListBox2.SelectedIndex.Equals(3))
            {
            ...
            // Ερώτηση 3
            if (this.checkedListBox3.SelectedIndex.Equals(0))
            {
            ...
            // Σύνδεση με βάση
            String sql = "";
            sql = "UPDATE [Students] SET Score6 = @correct WHERE [FirstName] = @fname and [SecondName] = @lname";
