...
{
    public partial class propaideia3test : Form
    {
        public propaideia3test()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ερώτηση 3
            if (this.checkedListBox3.SelectedIndex.Equals(3))
            {
            ...
            // Σύνδεση με βάση
            String sql = "";
            sql = "UPDATE [Students] SET Score3 = @correct WHERE [FirstName] = @fname and [SecondName] = @lname";
