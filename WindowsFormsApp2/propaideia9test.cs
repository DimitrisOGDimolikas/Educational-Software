...
{
    public partial class propaideia9test : Form
    {
        public propaideia9test()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ερώτηση 4
            if (this.checkedListBox4.SelectedIndex.Equals(3))
            {
            ...
            // Σύνδεση με βάση
            String sql = "";
            sql = "UPDATE [Students] SET Score9 = @correct WHERE [FirstName] = @fname and [SecondName] = @lname";
