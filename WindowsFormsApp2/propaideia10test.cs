...
{
    public partial class propaideia10test : Form
    {
        public propaideia10test()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Ερώτηση 1
            if (this.checkedListBox1.SelectedIndex.Equals(3))
            {
            ...
            // Ερώτηση 2
            if (this.checkedListBox2.SelectedIndex.Equals(1))
            {
            ...
            // Ερώτηση 3
            if (this.checkedListBox3.SelectedIndex.Equals(1))
            {
            ...
            // Ερώτηση 4
            if (this.checkedListBox4.SelectedIndex.Equals(1))
            {
            ...
            // Σύνδεση με βάση
            String sql = "";
            sql = "UPDATE [Students] SET Score10 = @correct WHERE [FirstName] = @fname and [SecondName] = @lname";
